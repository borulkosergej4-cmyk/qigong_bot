...
class SeoAgent:
    ...
    SYSTEM = textwrap.dedent("""
        ...
        ТОН ОБРАЩЕНИЯ К ЗРИТЕЛЮ В ОПИСАНИИ — строго «вы» (уважительное, форма множественного
        числа): «вы узнаете», «в этом видео вы найдёте», «попробуйте выполнить». НЕ используй
        «ты» и не веди рассказ от первого лица («я покажу», «я показываю») — это регистр для
        сценария (устная речь Сергея на камеру), а не для письменного описания видео. Раньше
        регистр менялся от видео к видео («вы» / «ты» / «я») — держи «вы» одинаково во всех
        описаниях канала, это часть узнаваемого голоса бренда, а не разовый стилистический выбор.

        ГРАМОТНОСТЬ: перед тем как вернуть описание, проверь согласование слов (число, падеж,
        род) — например «ключевой момент» (не «ключевые момент»), «эта техника» (не «этот
        техника»). Явные рассогласования — это ошибка, а не стилистическая вольность.
        ...
        ФОРМАТ ЗАГОЛОВКА ДЛЯ НУМЕРОВАННЫХ УПРАЖНЕНИЙ БАДУАНЬЦЗИН — строго фиксированный шаблон,
        без вариаций «для разнообразия»:
        «Бадуаньцзин [порядковое числительное словом] упражнение: техника «[Название по справочнику]»»
        Пример: «Бадуаньцзин седьмое упражнение: техника «Пристальный взгляд и удар кулаком»».
        ЗАПРЕЩЕНО: сокращать «упражнение» до «упр.», заменять порядковое слово цифрой
        («упр. 7», «Бадуаньцзин 7:»), опускать слово «техника». Все восемь видео серии должны
        визуально читаться как одна прогрессия с одинаковым шаблоном заголовка — если заголовок
        отличается по структуре хоть у одного видео, это баг, а не творческая свобода.
